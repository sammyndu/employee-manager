...
namespace EManager3.Migrations
{
    public partial class Subs : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //         HighestEducationQualification = table.Column<string>(nullable: true),
            //         School = table.Column<string>(nullable: true),
            //         ServiceYear = table.Column<DateTime>(nullable: true),
            //         CompanyPosition = table.Column<string>(nullable: true),
            //         LastPromotionDate = table.Column<DateTime>(nullable: true),
            //         YearlySalary = table.Column<int>(nullable: true)
            //     },
            //     constraints: table =>
            //     {
